...
#Aliases
alias altair='gnome-terminal -x bash -c "ssh root@altair.nodopiano.it";' 
alias amiga='gnome-terminal -x bash -c "ssh root@amiga.nodopiano.it";' 
alias atari='gnome-terminal -x bash -c "ssh root@atari.nodopiano.it";'
